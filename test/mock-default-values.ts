import {
  ...
  transactionStatus,
  transactionSubmit,
} from "../src/__mocks__/GatewayApiClient";
...
const TRANSACTION_COMMITTED_DETAILS_MOCK = transactionCommitedDetailsMock([
  "5c2100",
...
export function transactionCommitedDetailsMock(values: string[]) {
  return {
    transaction: {
      receipt: {
